            ...
            <Container>
                <div className="flex flex-col md:flex-row justify-between items-center gap-10 py-10 md:py-32">
                    ...
                    <div>
                        ...
                        <Button label="Get Started" rightIcon={<i className='bx bx-right-arrow-alt'></i>} className="font-mplus transition duration-150 text-white bg-[#772AB3] px-8 py-2 md:py-3 rounded-full text-base font-normal" />
                    </div>
                    {/* img */}
                    <div>
