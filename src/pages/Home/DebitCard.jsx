...
const DebitCard = () => {
    return (
        <section>
            <Container>
                <div className="flex flex-col md:flex-row justify-between items-center lg:gap-6 md:gap-5 gap-8 mt-10 md:mt-0">
                    <div>
                        <h1 className="lg:mb-4 md:mb-3 mb-4 text-2xl md:text-3xl lg:text-[40px] leading-[30px] md:leading-[35px] lg:md:leading-[57px] text-white font-bold">Wern Debit Card</h1>
